      ...
      this.main.append(
        ...
        el(
          ...
          el(
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/android/1.jpg",
            }),
          ),
          el(
            "li",
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/android/2.jpg",
            }),
          ),
          el(
            "li",
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/android/3.jpg",
            }),
          ),
      ...
      this.main.append(
        ...
        el(
          ...
          el(
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/ios/1.jpg",
            }),
          ),
          el(
            "li",
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/ios/2.jpg",
            }),
          ),
          el(
            "li",
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/ios/3.jpg",
            }),
          ),
          el(
            "li",
            ...
            el("img", {
              src:
                "https://resources.gaia.cc/images/pwa-install-popup/ios/4.jpg",
            }),
          ),
        ),
