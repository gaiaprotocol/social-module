...
export default class PostDisplay extends SoFiComponent {
    ...
    constructor(post, options, interactions) {
        ...
        if (options.inView) {
            ...
            this.append(authorProfileImage, el("main", el("header", authorDisplay, ownerMenuButton), messageDisplay, richDisplay, dateDisplay, actions)).onDom("click", () => interactions.openPostView(post.id));
        }
    }
