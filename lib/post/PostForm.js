import { AvatarUtil, Button, el, ErrorAlert, FileDropArea, Icon, msg, UploadForm, } from "@common-module/app";
export default class PostForm extends UploadForm {
    ...
    constructor(authorProfileImages, focus = false) {
        ...
        this.append(el("main", authorAvatar, el("form", this.input = new FileDropArea({ tag: "p.message-input", contenteditable: true }, (files) => this.appendFiles(files)), this.uploadPreviewArea = el(".upload-preview-area"))), el("footer", el("section.rich", el("button", new Icon("image"), {
