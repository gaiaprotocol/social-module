...
export default class PostForm extends UploadForm {
    ...
    constructor(authorProfileImage, focus = false) {
        ...
        }), el("form", this.input = new FileDropArea({ tag: ".message-input", contenteditable: true }, (files) => this.appendFiles(files)), this.uploadPreviewArea = el(".upload-preview-area"))), el("footer", el("section.rich", el("button", new Icon("image"), {
