    ...
    constructor(serviceName) {
        ...
        if (!BrowserInfo.isMobileDevice) {
            if (BrowserInfo.installed) {
                this.header.append(el("h1", msg("push-setting-popup-pc-app-title", { serviceName }), new Button({
                    tag: ".close",
                    type: ButtonType.Circle,
                    icon: new MaterialIcon("close"),
                    click: () => this.delete(),
                })));
                this.main.append(el("p", msg("push-setting-popup-pc-app-message-1", { serviceName })), el("ol", el("li", msg("push-setting-popup-pc-app-step-1", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/app/1.jpg",
                })), el("li", msg("push-setting-popup-pc-app-step-2", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/app/2.jpg",
                })), el("li", msg("push-setting-popup-pc-app-step-3", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/app/3.jpg",
                })), el("li", msg("push-setting-popup-pc-app-step-4", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/app/4.jpg",
                }))), el("p", msg("push-setting-popup-pc-app-message-2", { serviceName })));
            }
            else {
                this.header.append(el("h1", msg("push-setting-popup-pc-web-title", { serviceName }), new Button({
                    tag: ".close",
                    type: ButtonType.Circle,
                    icon: new MaterialIcon("close"),
                    click: () => this.delete(),
                })));
                this.main.append(el("p", msg("push-setting-popup-pc-web-message-1", { serviceName })), el("ol", el("li", msg("push-setting-popup-pc-web-step-1", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/web/1.jpg",
                })), el("li", msg("push-setting-popup-pc-web-step-2", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/web/2.jpg",
                })), el("li", msg("push-setting-popup-pc-web-step-3", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/web/3.jpg",
                })), el("li", msg("push-setting-popup-pc-web-step-4", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/web/4.jpg",
                })), el("li", msg("push-setting-popup-pc-web-step-5", { serviceName }), el("img", {
                    src: "/images/push-setting-popup/pc/web/5.jpg",
                }))), el("p", msg("push-setting-popup-pc-web-message-2", { serviceName })));
            }
        }
        else if (BrowserInfo.isAndroid) {
            if (BrowserInfo.installed) {
                this.header.append(el("h1", msg("push-setting-popup-android-app-title", { serviceName }), new Button({
                    tag: ".close",
                    type: ButtonType.Circle,
                    icon: new MaterialIcon("close"),
                    click: () => this.delete(),
                ...
                this.header.append(el("h1", msg("push-setting-popup-android-web-title", { serviceName }), new Button({
                    tag: ".close",
                    type: ButtonType.Circle,
                    icon: new MaterialIcon("close"),
                    click: () => this.delete(),
            ...
            this.header.append(el("h1", msg("push-setting-popup-ios-title", { serviceName })), new Button({
                tag: ".close",
                type: ButtonType.Circle,
                icon: new MaterialIcon("close"),
                click: () => this.delete(),
