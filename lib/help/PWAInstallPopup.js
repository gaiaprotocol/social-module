...
export default class PWAInstallPopup extends Popup {
    constructor(serviceName) {
        ...
        if (!BrowserInfo.isMobileDevice) {
            this.header.append(el("h1", msg("pwa-install-popup-pc-title", { serviceName })), new Button({
                tag: ".close",
                type: ButtonType.Circle,
                icon: new MaterialIcon("close"),
                click: () => this.delete(),
            }));
            this.main.append(el("p", msg("pwa-install-popup-pc-message-1", { serviceName })), el("ol", el("li", msg("pwa-install-popup-pc-step-1", { serviceName }), el("img", {
                src: "/images/pwa-install-popup/pc/1.jpg",
            })), el("li", msg("pwa-install-popup-pc-step-2", { serviceName }), el("img", {
