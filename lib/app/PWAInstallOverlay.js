...
export default class PWAInstallOverlay extends DomNode {
    constructor(serviceName, overviewUrl) {
        ...
        this.append(el("main", el("h1", serviceName), el("img.icon", { src: "/images/logo.png", alt: "Logo" }), el("h2", "Add To Home Screen"), el("p", `To install ${serviceName} app, you need to add this website to your home screen.`), new Button({
            ...
            href: overviewUrl,
            target: "_blank",
        })), el("footer", el("a.cancel", "Maybe later", { onClick: () => this.delete() })));
    }
}
